...
for(const b of books){
 const ed=primaryBrEdition(b),cover=ed?.cover_url||b.cover_url||'',author=b.authors?.name||'Autor não informado';
 ...
 const facts=[
  ...
  b.original_year?'<div><small>Ano original</small><strong>'+esc(b.original_year)+'</strong></div>':'',

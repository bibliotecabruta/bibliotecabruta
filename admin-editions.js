...
function editEditionAdmin(id){
 ...
 f.elements.edition_title.value=e.edition_title||'';f.elements.edition_title.value=e.edition_title||'';f.elements.publisher.value=e.publisher||'';

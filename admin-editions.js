...
async function saveEditionAdmin(ev){
 ...
 try{
   ...
   const autoNewest=!editionId&&savedYear!=null&&(!currentPrimary?.publication_year||savedYear>currentPrimary.publication_year);

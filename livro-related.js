...
function relThumb(url){const raw=String(url||'');if(!raw)return'';try{const u=new URL(raw,location.origin),p='/storage/v1/object/public/';if(u.hostname.endsWith('.supabase.co')&&u.pathname.includes(p)){u.pathname=u.pathname.replace(p,'/storage/v1/render/image/public/');u.searchParams.set('width','260');u.searchParams.set('quality','82');u.searchParams.set('resize','contain')}return u.href}catch{return raw}}

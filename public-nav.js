...
function initPublicFooter(){
  ...
  const items=[['Ficção Histórica','historica.html'],['Policial / Mistério','policial.html'],['Notícias','noticias.html'],['Catálogo','catalogo.html'],['Autores','autores.html'],['Séries','series.html'],['Categorias','categorias.html'],['Temas','temas.html'],['Sobre','sobre.html']];

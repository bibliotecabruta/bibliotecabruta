...
function updateAuthorBreadcrumbData(a){
 ...
 let script=document.getElementById('bbAuthorBreadcrumbData');
 if(!script){script=document.createElement('script');script.type='application/ld+json';script.id='bbAuthorBreadcrumbData';document.head.appendChild(script)}
...
async function loadAuthor(){
 ...
 updateAuthorMeta(a,books);updateAuthorStructuredData(a,books);updateAuthorBreadcrumbData(a);
